...
use Contao\CoreBundle\EventListener\StoreRefererListener as ContaoStoreRefererListener;

/**
 * NOTE: THIS IS TEMPORARY UNTIL THE "REFERER" ISSUE IS FIXED IN CONTAO
 * @internal
 */
class StoreRefererListener extends ContaoStoreRefererListener
{
    /**
     * @var Security
     */
